...
import { Button, Spinner } from "@townhawll/ui";
import { useFormStatus } from "react-dom";

import { adminGoogleSignInAction } from "./google-actions";
...
export function AdminGoogleAuthButton({
  callbackUrl,
}: Readonly<{ callbackUrl: string }>) {
  return (
    <>
      <form action={adminGoogleSignInAction} className="mt-6">
